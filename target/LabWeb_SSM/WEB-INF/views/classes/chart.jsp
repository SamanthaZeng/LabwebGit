...
<html lang="en">
	...
	<body>
		...
		//加载数据
		var d = "${chartList[0].subject}";//subject表示横轴的科目，竖轴为每个班级人数
		var data1 = {
		    ...
		    datasets: [
		        {
		            ...
		            label: "2018年",
		            data: ["${chartList[0].s_count}", "${chartList[1].s_count}", //0-5表示classes里面的6个班级
		...
		window.onload = function(){
			var ctx = document.getElementById("canvas").getContext("2d");//canvas为定义的区域，用来展示报表
