                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                        ...
                                                        <a class="green" href="/news/edit?newsid=${news.newsid}" title="edit">
                                                            <i class="icon-pencil bigger-130"></i>
                                                        </a>

                                                        <a class="red" href="/news/delete?newsid=${news.newsid}" title="delete">
    ...
    jQuery(function($) {
        ...
        $('#delBtn').click( function () {
            ...
            if(id == 0){
                ...
                //调用controller层中写的方法
                location.href="/news/delete?newsid="+id;
            }
        } );
        ...
        $('#editBtn').click( function () {
            ...
            if(id == 0){
                ...
                location.href="/news/edit?newsid="+id;
            }
        } );
