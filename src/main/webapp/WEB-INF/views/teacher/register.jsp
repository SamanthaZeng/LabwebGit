            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" method="post" action="/teacher/register" enctype="multipart/form-data"  accept-charset="UTF-8">
                            <!--新增点击过来，没有id，修改点过来有id-->
                            <input type="hidden" name="id" value="${user.id}"/>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 教师邮箱 </label>

                                <div class="col-sm-9">
                                    <input type="text" name="tmail" id="form-field-1" placeholder="教师邮箱" class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-2">教师职务</label>

                                <div class="col-sm-9">
                                    <input type="text" name="tduty" id="form-field-2" placeholder="教师职务" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="teduexp" style="resize:none;" class="col-sm-5" rows="10">教育经历</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="workexp" style="resize:none;" class="col-sm-5" rows="10">工作经历</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="service" style="resize:none;" class="col-sm-5" rows="10">社会服务</textarea>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="id-input-file-3"> 教师头像 </label>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">教师职称</label>
                                <div class="col-sm-9">
                                    <select class="col-xs-10 col-sm-5" id="selectpicker" name="trank" >
