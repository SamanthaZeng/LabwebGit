                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" method="post" action="/teacher/register" enctype="multipart/form-data"  accept-charset="UTF-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="teduexp" cols="53" rows="10">教育经历</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="workexp" cols="53" rows="10">工作经历</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="service" cols="53" rows="10">社会服务</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select class="col-xs-10 col-sm-5" id="selectpicker" name="trank" >
                                        ...
                                        <option value="0" >副教授</option>
                                        <option value="0" >助理教授</option>
