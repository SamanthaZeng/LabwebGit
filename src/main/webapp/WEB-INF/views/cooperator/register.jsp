            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" method="post" action="/cooperator/register" enctype="multipart/form-data"  accept-charset="UTF-8">
                            <!--新增点击过来，没有id，修改点过来有id-->
                            <input type="hidden" name="id" value="${user.id}"/>


                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-2">合作者头衔</label>

                                <div class="col-sm-9">
                                    <input type="text" name="title" id="form-field-2" placeholder="合作者头衔" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="id-input-file-4"> 公司职务 </label>

                                <div class="col-sm-9">
                                    <input type="text" name="cduty" id="id-input-file-4" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
